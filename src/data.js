...
3. Three tests are run: Camera, Network, and Audio. 
    ...
    4. After the tests are completed, you can begin the one way interview. You will first complete a practice question to familiarize yourself with the platform and style of the video interview.
...
If you ever need help, just hit the chat button on the bottom right of your screen. Our support team monitors this chat 24/7, and are always available to help you through technical issues and any questions you may have!`,
  ...
  },
  {
    ...
    ### You should see a page like this. Make sure Google Chrome has camera access.
  ...
  },
  {
    ...
    markdown: `# Here is a list of 70 example interview questions:
